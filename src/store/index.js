...
export const useItemsStore = defineStore("myClasses", {
  ...
  actions: {
    async fetchItems() {
      try {
        const response = await fetch("http://localhost:3000/classes"); // preciso colocar o endPoint correto aqui, onde o meu local host está rodando da mongodb e do meu router. router have to match com o endpoint do mongo.js
